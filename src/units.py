...
class EncoderLayer(nn.Module):
    def __init__(self, d_model, num_heads, d_ff, use_residual=True, use_layer_norm=True):
        super().__init__()
        self.self_attn = MultiHeadAttention(d_model, num_heads)
        self.norm1 = AddNorm(d_model, use_residual, use_layer_norm)

        self.ffn = PositionwiseFeedForward(d_model, d_ff)
        self.norm2 = AddNorm(d_model, use_residual, use_layer_norm)
...
class DecoderLayer(nn.Module):
    def __init__(self, d_model, num_heads, d_ff, use_residual=True, use_layer_norm=True):
        ...
        self.ffn = PositionwiseFeedForward(d_model, d_ff)
        self.norm3 = AddNorm(d_model, use_residual, use_layer_norm)
